...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> fetchWordOfTheDay() async {
    try {
      final response = await http.get(
        Uri.parse('http://192.168.1.10:8002/word-of-the-day/today'),
  ...
  Future<void> fetchStreaks() async {
    ...
    final dio = Dio();
    final url = 'http://192.168.1.10:8000/activity/get_streaks';
  ...
  Future<void> fetchPracticeHours() async {
    ...
    final url = Uri.parse('http://192.168.1.10:8000/activity/get_practice_hours');
