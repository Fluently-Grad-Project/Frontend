...
class _MatchmakingPageState extends State<MatchmakingPage> {
  ...
  Future<void> _loadData() async {
    ...
    String matchmakingUrl = "http://192.168.1.32:8000/matchmaking/get-matched-users?n_recommendations=5";
  ...
  Future<User?> _fetchUserProfile(int userId, String? token, {required Map<String, dynamic> initialData}) async {
    String profileUrl = "http://192.168.1.32:8000/users/$userId/profile";
    try {
