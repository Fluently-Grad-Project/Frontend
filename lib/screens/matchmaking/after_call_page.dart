...
class _AfterCallPageState extends State<AfterCallPage> {
  ...
  Future<void> _sendFriendRequest(BuildContext context, String recipientUserId, String recipientName) async {
    ...
    final dio = Dio();
    final String friendRequestApiUrl = "http://${IpAddress}:8000/friends/request/$recipientUserId"; // TODO: Replace with your real API endpoint
  ...
  Future<void> _submitRating(double ratingToSubmit) async {
    ...
    final String rateUserApiUrl = "http://${IpAddress}:8000/users/rate-user/${_user!.id}";
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: (userToDisplay.profile_image != null && userToDisplay.profile_image!.isNotEmpty)
                                    ? NetworkImage("http://${IpAddress}:8000/uploads/profile_pics/${userToDisplay.profile_image!}")
                                    : null,
