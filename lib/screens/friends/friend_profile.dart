...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _fetchInitialUserRating() async {
    ...
    // For example:
    try {
      final response = await _dio.get("http://192.168.1.32:8000/users/${user.id}/rating" // Fictional endpoint
      );
  ...
  Future<void> _blockUserApiCall(String userIdToBlock, String userName) async {
    ...
    final String blockUserApiUrl = "http://192.168.1.32:8000/users/block-user/$userIdToBlock";
  ...
  Future<void> _submitRating(double ratingToSubmit) async {
    ...
    final String rateUserApiUrl = "http://192.168.1.32:8000/users/rate-user/${user.id}";
