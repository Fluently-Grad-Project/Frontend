...
class _MyProfilePageState extends State<MyProfilePage> {
  ...
  Future<bool> _uploadProfileImageApiCall(File imageFile, BuildContext pageContext) async {
    ...
    String uploadProfileImageApiUrl = "http://${IpAddress}:8000/users/upload-profile-picture";
  ...
  Future<bool> _updateProfileApiCall(Map<String, dynamic> data, BuildContext pageContext) async {
    ...
    final String updateProfileApiUrl = "http://${IpAddress}:8000/users/update-profile";
  ...
  Future<void> _logoutApiCall(BuildContext context) async {
    final String logoutApiUrl = "http://${IpAddress}:8000/users/logout";
    final SharedPreferences prefs =  await SharedPreferences.getInstance();
                        ...
                        children: [
                          CircleAvatar(
                            ...
                            backgroundImage: (user.profile_image != null && user.profile_image!.isNotEmpty)
                                ? NetworkImage("http://${IpAddress}:8000/uploads/profile_pics/${user.profile_image!}")
                                : null,
